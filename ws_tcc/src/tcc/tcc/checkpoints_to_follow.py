...
class checkpoints_to_follow(Node):
    ...
    def __init__(self):
        ...
        self.goal_pose13 = self.create_pose_stamped(2.7, 0.0, 3.14)
        self.goal_pose14 = self.create_pose_stamped(3.0, -0.35, 3.14)
        self.goal_pose15 = self.create_pose_stamped(-2.8, -0.35, 0.0)
        self.goal_pose16 = self.create_pose_stamped(-2.8, -0.6, 0.0)
        self.goal_pose17 = self.create_pose_stamped(1.25, -0.6, 0.0)
        self.goal_pose18 = self.create_pose_stamped(2.7, -0.6, 0.0)
        self.goal_pose19 = self.create_pose_stamped(2.7,-0.9, 0.0)
