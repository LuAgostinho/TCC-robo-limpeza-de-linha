...
class checkpoints_to_follow(Node):
    ...
    def __init__(self):
        ...
        self.goal_pose7 = self.create_pose_stamped(-2.65, -0.85, 0.0)
        self.goal_pose8 = self.create_pose_stamped(-1.7,-0.9, 0.0)
        self.goal_pose9 = self.create_pose_stamped(-0.6,-0.9, 1.57)
        self.goal_pose10 = self.create_pose_stamped(1.5,-0.9, 1.5)
        self.goal_pose11 = self.create_pose_stamped(2.5,-0.9, 1.5)
        self.goal_pose12 = self.create_pose_stamped(3.0,-0.5, 3.1)
        self.goal_pose13 = self.create_pose_stamped(3.0,0.3, 1.5)
        self.goal_pose14 = self.create_pose_stamped(3.0,0.9, 3.1)
        self.goal_pose15 = self.create_pose_stamped(-2.6,0.9, 4.7)
        self.goal_pose16 = self.create_pose_stamped(-2.6,-0.5, 0.3)
        self.goal_pose17 = self.create_pose_stamped(2.1,-0.7, 1.5)
        self.goal_pose18 = self.create_pose_stamped(2.2,0.4, 3.1)
        ...
        self.goal_pose23 = self.create_pose_stamped(-1.8, 0.2, 4.7)
        self.goal_pose24 = self.create_pose_stamped(-1.8, -0.2, 0.0)
        self.goal_pose25 = self.create_pose_stamped(1.25, -0.4, 3.1)
