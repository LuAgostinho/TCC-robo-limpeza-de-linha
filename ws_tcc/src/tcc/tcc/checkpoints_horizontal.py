...
class checkpoints_to_follow(Node):
    ...
    def __init__(self):
        ...
        self.goal_pose17 = self.create_pose_stamped(0.3, 0.5, 4.7)
        ...
        self.goal_pose32 = self.create_pose_stamped(-2.7, -0.85, 2.0)
        self.goal_pose33 = self.create_pose_stamped(-3.05, -0.25, 1.57)
        self.goal_pose34 = self.create_pose_stamped(-3.05, 0.25, 1.57)
