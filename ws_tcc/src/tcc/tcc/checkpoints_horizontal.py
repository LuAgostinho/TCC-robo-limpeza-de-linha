...
class checkpoints_to_follow(Node):
    ...
    def __init__(self):
        ...
        self.goal_pose2 = self.create_pose_stamped(2.8, 0.3, 1.5)
        self.goal_pose3 = self.create_pose_stamped(2.8, 1.0, 4.7)
        self.goal_pose4 = self.create_pose_stamped(2.5, -0.95, 1.5)
        self.goal_pose5 = self.create_pose_stamped(2.5, 0.9, 3.1)
        self.goal_pose6 = self.create_pose_stamped(2.05, 0.85, 4.5)
        self.goal_pose7 = self.create_pose_stamped(2.0, -1.0, 3.1)
        self.goal_pose8 = self.create_pose_stamped(1.5, -1.0, 1.5)
        self.goal_pose9 = self.create_pose_stamped(1.5, 0.1, 2.5)
        self.goal_pose10 = self.create_pose_stamped(1.2, 1.0, 4.7)
        self.goal_pose11 = self.create_pose_stamped(1.15, -0.95, 1.5)
        ...
        self.goal_pose15 = self.create_pose_stamped(-0.3, -0.9, 1.5)
        self.goal_pose16 = self.create_pose_stamped(-0.2, 0.5, 0.0)
        self.goal_pose17 = self.create_pose_stamped(0.3, 0.5, 1.5)
        self.goal_pose18 = self.create_pose_stamped(0.3, 0.8, 3.1)
        self.goal_pose19 = self.create_pose_stamped(-0.4, 0.8, 3.1)
        self.goal_pose20 = self.create_pose_stamped(-0.6, 1.2, 4.7)
        self.goal_pose21 = self.create_pose_stamped(-0.6, -0.8, 2.0)
        ...
        self.goal_pose25 = self.create_pose_stamped(-1.5, 1.1, 4.7)
        ...
        self.goal_pose29 = self.create_pose_stamped(-2.2, -0.5, 1.5)
        self.goal_pose30 = self.create_pose_stamped(-2.2, 1.2, 3.1)
        self.goal_pose31 = self.create_pose_stamped(-2.6, 1.2, 4.7)
        self.goal_pose32 = self.create_pose_stamped(-2.7, -0.7, 2.0)
        self.goal_pose33 = self.create_pose_stamped(-3.05, -0.25, 1.5)
        self.goal_pose34 = self.create_pose_stamped(-3.05, 0.25, 0.3)
        self.goal_pose35 = self.create_pose_stamped(-3.0, 1.2, 3.14)
