...
class checkpoints_to_follow(Node):
    ...
    def __init__(self):
        ...
        self.goal_pose5 = self.create_pose_stamped(-2.9, 0.25, 4.7)
        ...
        self.goal_pose9 = self.create_pose_stamped(-0.7,-0.9, 1.57)
        ...
        self.goal_pose18 = self.create_pose_stamped(2.2,0.6, 3.1)
