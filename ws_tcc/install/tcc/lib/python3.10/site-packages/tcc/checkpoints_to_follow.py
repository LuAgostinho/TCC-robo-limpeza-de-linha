...
class checkpoints_to_follow(Node):
    ...
    def __init__(self):
        ...
        self.goal_pose6 = self.create_pose_stamped(3.0, 0.5, 3.1)
        self.goal_pose7 = self.create_pose_stamped(-0.6, 0.6, 3.1)
        self.goal_pose8 = self.create_pose_stamped(-2.45, 0.7, 3.1)
        self.goal_pose9 = self.create_pose_stamped(-2.7, 0.3, 0.3)
        self.goal_pose10 = self.create_pose_stamped(-1.0, 0.1, 0.3)
